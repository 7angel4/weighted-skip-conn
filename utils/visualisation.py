...
def visualise_embeddings(models, model_name, dataset_name, 
                         layers=VIS_LAYERS, dir=OUTPUT_DIR):
    """
    ...
    for n, df in feature_dict.items():
        visualise_one(n, df, model_name, dataset_name, dir=dir)


def visualise_one(n, df, model_name, dataset_name, dir=OUTPUT_DIR) -> None:
    ...
    # show the plot
    plt.show()
    fig.savefig(dir + f'{dataset_name}/{model_name}/{n}_layer_vis.jpg', bbox_inches='tight')
